...
Feign 是远程调用的发起方，FallbackFactory 本质上就是给这个“远程调用”准备兜底方案的；而 BlockExceptionHandler 是 Sentinel 资源层面的统一异常处理，两者不是一个维度的东西。
...
#### 原始模式, 保存在内存中
#### pull模式
![[Pasted image 20260909163739.png]]
#### push模式
![[Pasted image 20260909163818.png]]
...
![[Pasted image 20260910101516.png]]
![[Pasted image 20260910101758.png]]
![[Pasted image 20260910101849.png]] 
##### TCC 模式
...
![[Pasted image 20260910103410.png]]

##### Saga 模式
![[Pasted image 20260910104749.png]]![[Pasted image 20260910104916.png]]

#### 高可用
![[Pasted image 20260910105215.png]]